 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 623 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  if(*f == '.') {
   flag |= 0x4000;
   f++;
# 639 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
   {
    prec = 0;
...
# 1309 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  if(prec == 0 && val == 0)
   prec++;
# 1324 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
   for(c = 1 ; c != sizeof dpowers/sizeof dpowers[0] ; c++)
    if(val < dpowers[c])
     break;
# 1358 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  if(c < prec)
   c = prec;
  else if(prec < c)
   prec = c;
